# object-storage-settings Specification

## Purpose

Let users configure, test, and persist S3-compatible object storage at runtime with encrypted credentials and no environment-variable configuration.
## Requirements
