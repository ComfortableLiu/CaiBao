...
The application provides a Provider Settings page where users configure LLM provider protocol settings (DashScope or OpenAI-compatible), synchronize available models, and enable models for use in the chat UI.
